...
destination = [
    'output_resample_filter/Sub_9_0_resample.csv',
    # 'output_resample_filter/Sub_18_0_resample.csv',
    # 'output_resample_filter/Sub_18_1_resample.csv',
    # 'output_resample_filter/Sub_19_0_resample.csv',
    # 'output_resample_filter/Sub_19_1_resample.csv',
    # 'output_resample_filter/Sub_21_1_resample.csv',
    # 'output_resample_filter/Sub_21_2_resample.csv',
    # 'output_resample_filter/Sub_22_1_resample.csv',
    # 'output_resample_filter/Sub_22_2_resample.csv',
    # 'output_resample_filter/Sub_23_1_resample.csv',
    # 'output_resample_filter/Sub_23_2_resample.csv',
    # 'output_resample_filter/Sub_24_0_resample.csv',
    # 'output_resample_filter/Sub_24_1_resample.csv',
    # 'output_resample_filter/Sub_25_0_resample.csv',
    # 'output_resample_filter/Sub_25_1_resample.csv',
    # 'output_resample_filter/Sub_26_0_resample.csv',
    # 'output_resample_filter/Sub_26_1_resample.csv',
    # 'output_resample_filter/Sub_29_0_resample.csv',
    # 'output_resample_filter/Sub_30_0_resample.csv',
]
# 逐一處理每對檔案
